...
echo 'Installing Functions Companion v1.35'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001EfHQ -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001EfHQ -u "${username}"
echo ''
