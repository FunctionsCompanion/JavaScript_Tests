...
echo 'Installing Functions Companion v1.29'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001AQAV -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001AQAV -u "${username}"
echo ''
