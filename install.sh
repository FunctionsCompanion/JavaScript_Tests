...
echo 'Installing Functions Companion v1.32'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001Ed4m -u' ${username}  04t8c000001Ed4m
sfdx force:package:install -r --wait 10 --package 04t8c000001Ed4m -u "${username}"
echo ''
