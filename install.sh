...
echo 'Installing Functions Companion v1.38'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001IscY -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001IscY -u "${username}"
echo ''
