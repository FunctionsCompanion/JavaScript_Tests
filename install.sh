...
echo 'Installing Functions Companion v1.33'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001Edgf -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001Edgf -u "${username}"
echo ''
