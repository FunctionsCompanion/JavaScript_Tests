...
echo 'Installing Functions Companion v1.36'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001EfHV -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001EfHV -u "${username}"
echo ''
