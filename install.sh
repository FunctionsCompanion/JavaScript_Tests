...
echo 'Installing Functions Companion v1.34'
echo 'sfdx force:package:install -r --wait 10 --package 04t8c000001Ef7TAAS -u' ${username}
sfdx force:package:install -r --wait 10 --package 04t8c000001Ef7TAAS -u "${username}"
echo ''
